...
namespace WebApp
{
    public partial class jobs : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string limitQuery = "Select COUNT(*) FROM ARTICLE WHERE [article_Type] = 2";
            ...
            else
            {
                int nextpage = page + 1;
                next.Enabled = true;
                next.NavigateUrl = "~/jobs.aspx?page=" + nextpage + "";
            }
            ...
            else
            {
                prev.Enabled = true;
                int prevpage = page - 1;
                prev.NavigateUrl = "~/jobs.aspx?page=" + prevpage + "";
            }
            //End of Pagination
            ...
            if (!Page.IsPostBack)
            {
                ...
                string query = "SELECT TOP 15 * FROM ( Select TOP " + max + " * FROM [ARTICLE] WHERE [article_Type] = 2 ORDER BY [article_Date] ASC) WHERE [article_App] = true AND [article_Type] = 2 ORDER BY [article_Date] DESC ";
