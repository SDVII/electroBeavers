...
namespace WebApp
{
    public partial class hide : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["user_id"] != null)
            {
                ...
                string queryAllowed = "SELECT COUNT(*) FROM [HIDDEN] WHERE [article_ID] = " + id + " AND [user_ID] = " + user_id + " ";
                ...
                if (allowed == 0)
                {
                    ...
                    string query = "INSERT INTO HIDDEN ([user_ID], [article_ID]) VALUES ('" + user_id + "','" + id + "')";
